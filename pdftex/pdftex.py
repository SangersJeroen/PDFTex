...
class RendererPdfTex(RendererBase):
...
class FigureCanvasPdfTex(FigureCanvasBase):
    filetypes = {'pdf_tex': 'pdf and Scalable Vector Graphics'}
...
FigureManagerPdfTex = FigureManagerBase
...
@_Backend.export
class _BackendPdfTex(_Backend):
    FigureCanvas = FigureCanvasPdfTex
